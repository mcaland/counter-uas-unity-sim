...
namespace andywiecko.BurstTriangulator
{
    public class Triangulator : IDisposable
    {
        ...
        public JobHandle Schedule(JobHandle dependencies = default)
        {
            ...
            dependencies = new CleanupTrianglesJob(this).Schedule(this.data.triangles.Length, 128, dependencies);
        ...
        {
            dependencies = new PCAInverseTransformationJob(this).Schedule(this.Output.Positions.Length, 128, dependencies);
        ...
        private JobHandle ScheduleWorldToLocalTransformation(JobHandle dependencies)
        {
            ...
            dependencies = new CalculateLocalPositionsJob(this).Schedule(this.localPositions.Length, 128, dependencies);
        ...
        {
            dependencies = new LocalToWorldTransformationJob(this).Schedule(this.Output.Positions.Length, 128, dependencies);
        ...
        private JobHandle ScheduleConstrainEdges(JobHandle dependencies)
        {
            ...
            new ResizeEdgeConstraintsJob(this).Schedule(dependencies).Complete();
            dependencies = new ConstructConstraintEdgesJob(this).Schedule(data.constraintEdges.Length, Settings.BatchCount, dependencies);
        ...
        [BurstCompile]
        private struct PCAInverseTransformationJob : IJobParallelFor
        {
        ...
        [BurstCompile]
        private struct CalculateLocalPositionsJob : IJobParallelFor
        {
            private NativeReference<float2>.ReadOnly comRef;
            private NativeReference<float2>.ReadOnly scaleRef;
        ...
        [BurstCompile]
        private struct LocalToWorldTransformationJob : IJobParallelFor
        {
            private NativeArray<float2> positions;
            private NativeReference<float2>.ReadOnly comRef;
            private NativeReference<float2>.ReadOnly scaleRef;
        ...
        [BurstCompile]
        private struct ConstructConstraintEdgesJob : IJobParallelFor
        {
            [ReadOnly]
            private NativeArray<int> inputConstraintEdges;
        ...
        [BurstCompile]
        private unsafe struct CleanupTrianglesJob : IJobParallelFor
        {
            [ReadOnly]
